...
export default function CompetitorOverviewTable({ data, loading, sort, handleSort }: CompetitorOverviewTableProps) {
    if (loading) return <div>Loading competitor analysis...</div>;
    ...
    return (
        <div style={{ background: '#fff', borderRadius: '8px', border: '1px solid #e2e8f0', overflow: 'hidden', overflowX: 'auto', maxHeight: '70vh', overflowY: 'auto' }}>
